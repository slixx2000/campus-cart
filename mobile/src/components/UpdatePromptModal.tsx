        ...
        <Pressable style={styles.feedbackModalCard} onPress={(event) => event.stopPropagation()}>
          ...
          {updateInfo ? (
            <View style={{ width: '100%', gap: 8, marginTop: 2 }}>
              ...
              >
                <Text style={{ color: colors.muted, fontSize: text.xs, fontWeight: '700' }}>Current version</Text>
                <Text style={{ color: colors.fg, fontSize: text.base, fontWeight: '800' }}>{updateInfo.currentVersion}</Text>
              </View>
              <View
                style={{
                  borderRadius: radius.sm,
              ...
              >
                <Text style={{ color: colors.warning, fontSize: text.xs, fontWeight: '700' }}>Latest release</Text>
                <Text style={{ color: colors.fg, fontSize: text.base, fontWeight: '800' }}>{updateInfo.latestVersion}</Text>
              </View>
            </View>
          ) : null}
          ...
          >
            <Text style={[styles.secondaryButtonText, { color: colors.accent }]}>View release notes</Text>
          </Pressable>
          <Pressable
            style={[
              styles.secondaryButton,
